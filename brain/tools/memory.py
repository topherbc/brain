...
class MemoryDatabaseBackend:
    """Backend SQLite database implementation."""
...
_db = MemoryDatabaseBackend()

def store_memory(memory_type: str, content: Any, 
...
def retrieve_memories(query: Dict[str, Any] = None,
...
def update_memory(memory_id: int, updates: Dict[str, Any]) -> bool:
...
memory_store = BaseTool(
    name="memory_store",
    func=store_memory,
    description="Store a new memory with type, content, optional tags, metadata, and importance score."
)

memory_retrieve = BaseTool(
    name="memory_retrieve",
    func=retrieve_memories,
    description="Retrieve memories based on search criteria like type, tags, and importance."
)

memory_update = BaseTool(
    name="memory_update",
    func=update_memory,
    description="Update an existing memory's fields like content, type, metadata, or importance."
)

memory_delete = BaseTool(
    name="memory_delete",
    func=delete_memory,
    description="Delete a memory and its associated tags from the database."
)